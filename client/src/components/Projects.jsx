        ...
        <Row className="align-items-center justify-content-center">
          <Col lg={8} md={6}>
            ...
            <Row style={{ marginTop: 100 }}>
              ...
              >
                <AccordionSummary onClick={handleToggle1}>
                    ...
                    <div className="intro p-4" style={{ textAlign: "left" }}>
                      ...
                      <p className="intro" style={{ textAlign: "left" }}>
                        ...
                        <Link
                          ...
                          href="https://usetract.com"
                        >
                          <span className="bold">TRACT</span>
                        </Link>
                        , I mainly served as a frontend developer using skill of
                        TypeScript and React, developed the official website
                        page of{" "}
                        <Link
                          underline="hover"
                          key="1"
                        ...
                        , improving website's UI/UX
                      </p>
                      <p className="boldsub pt-4"> 🤖 TECHS: </p>

                      <p className="intro" style={{ textAlign: "left" }}>
                        Typescript, React, AWS services
                      </p>
                      <p className="boldsub pt-4"> 👨‍💻 MY POSITION: </p>

                      <p className="intro" style={{ textAlign: "left" }}>
                        Leveraged React components, managed state using Redux,
                        and utilized Axios for API calls. Employed CSS modules
                        for styling to ensure modularity and avoid conflicts.
                        Contributed to the user Authentication and Authorization
                        APIs development and integration in the backend, working
                        closely with the team to optimize performance and
                        functionality; Published website updates with AWS EC2
                        and Nginx, ensuring seamless deployment and
            ...
            <Row style={{ marginTop: 20 }}>
              ...
              >
                <AccordionSummary onClick={handleToggle2}>
                  <h4 className="name">MOVIEPROX</h4>
                  <ArrowIcon
                ...
                <AccordionDetails sx={{ m: 0 }}>
                  ...
                  >
                    <div className="intro p-4" style={{ textAlign: "left" }}>
                      <Link href="https://movieprox.vercel.app/">
                        <img
                          src={MovieProx}
                          className="p-4 px-0"
                          style={{ maxWidth: "100%", height: "auto" }}
                      ...
                      <p className="boldsub pt-4"> 📝 ABOUT: </p>
                      <p className="intro" style={{ textAlign: "left" }}>
                        MovieProx is a fullstack responsive Nextflix-like
                        website built with MERN (MongoDB, Express, React,
                        Node.js) stack and the Themoviedb API. Users <br />
                        can sign up, search movies, TVs and people, add movies
                        to favorite list,
                        <br /> write reviews
                      </p>
                      <p className="boldsub pt-4"> 🤖 TECHS: </p>
                      ...
                      <p className="intro" style={{ textAlign: "left" }}>
                        Javascript, React, Node.js, Mongoose, Axios, Redux
                      </p>
                      <p className="boldsub pt-4"> 👨‍💻 MY POSITION: </p>

                      <p className="intro" style={{ textAlign: "left" }}>
                        Developed the frontend with Material UI and react,
                        server APIs with Express and make API calls to the
                        Themoviedb API <br />
                        by deploying Axios clients; Provided user authentication
                        and protection with JWT and Express Validator; Deployed
                        the application on Vercel and host the database on
            ...
            <Row style={{ marginTop: 20 }}>
              ...
              >
                <AccordionSummary onClick={handleToggle3}>
                  <h4 className="name">JOI</h4>
                  <ArrowIcon
                ...
                <AccordionDetails sx={{ m: 0 }}>
                  ...
                  >
                    <div className="intro p-4" style={{ textAlign: "left" }}>
                      <Link href="https://github.com/rentxiang/TodoApp/tree/master/client">
                        <img
                          src={Joi}
                          className="p-4 px-0"
                          style={{ maxWidth: "100%", height: "auto" }}
                      ...
                      <p className="boldsub pt-4"> 📝 ABOUT: </p>
                      <p className="intro" style={{ textAlign: "left" }}>
                        Joi is Todo AI assistant solution built with react and
                        OpenAI API for{" "}
                        <Link
                          underline="hover"
                          key="1"
                          color="inherit"
                          href="https://astriaai.com/"
                        >
                          <span className="bold">Astria</span>
                        </Link>
                        . Users can effortlessly plan their tasks or seek
                        instructions and steps from the AI for their todos.
                      </p>
                      <p className="boldsub pt-4"> 🤖 TECHS: </p>
                      ...
                      <p className="intro" style={{ textAlign: "left" }}>
                        Developed the todos CRUD functionalities, user
                        interfaces and server APIs with Javacripte and Express
                      </p>
            ...
            <Row style={{ marginTop: 20 }}>
              ...
              >
                <AccordionSummary onClick={handleToggle4}>
                  <h4 className="name">HUSKYHUB</h4>
                  <ArrowIcon
                ...
                <AccordionDetails sx={{ m: 0 }}>
                  ...
                  >
                    <div className="intro p-4" style={{ textAlign: "left" }}>
                      <div className="text-center">
                        <Link href="https://siliconvalley.northeastern.edu/">
                          <img
                            ...
                            alt=""
                          />
                          Northeastern Univerity in Silicon Valley
                        </Link>
                      </div>

                      <Link href="https://github.com/rentxiang/Huskyhub">
                        <img
                          src={Huskyhub}
                          className="p-4 px-0"
                          style={{ maxWidth: "100%", height: "auto" }}
                      ...
                      <p className="boldsub pt-4"> 📝 ABOUT: </p>
                      <p className="intro" style={{ textAlign: "left" }}>
                        Huskyhub is an original pioneer program designed by the
                        Silicon Valley Hackers Club to support student life and
                        foster a community for students at Northeastern
                        University to join and engage in discussions.
                      </p>
                      <p className="boldsub pt-4"> 🤖 TECHS: </p>
                      ...
                      <p className="intro" style={{ textAlign: "left" }}>
                        Finished and developed the frontend with HTML and
                        backend with Django framework{" "}
                      </p>

                      <Breadcrumbs
                        separator=" "
                        aria-label="breadcrumb4"
                        className="d-flex px-0 p-4  "
                      >
                        {breadcrumbs4}
                      </Breadcrumbs>
